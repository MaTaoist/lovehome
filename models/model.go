...
func init() {
	...
	orm.RegisterDataBase("default" , "mysql", "root:454611@tcp(127.0.0.1:3306)/ihome?charset=utf8", 30)

	// register model
	orm.RegisterModel(new(User),new(OrderHouse),new( HouseImage),new(House),new(Area),new(Facility))
